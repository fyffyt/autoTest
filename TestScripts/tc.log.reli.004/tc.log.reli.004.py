...
if __name__ == '__main__':
    """If disk usage over threshold, log module will delete oldest local log file."""
    ...
    # just when remained space == less than 128M , BS-video dir on device shall be cleaned.
    print('abortion failure: %s' % (ssh_dp_proc.before))
    raise Exception('abortion failure')
    #####################<check postcondition>########################
