...
TESTCASE_ID = "Tc.upload.func.009"
TESTCASE_PRI = "L"
...
if __name__ == '__main__':
    """Upload module should sleep only when the node config to rest time
    && all data file has been uploaded."""
    ...
    # 2nd para for check_module_health: 'config','log','upload'
    ...
    # config FusionSensor sleep time
    cur_time = time.time()
