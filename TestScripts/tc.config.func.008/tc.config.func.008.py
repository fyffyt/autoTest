...
TESTCASE_ID = "Tc.config.func.008"
TESTCASE_PRI = "M"
...
if __name__ == '__main__':
    # TODO web socket has no relative config items.
    """When a node's config file has updated , web socket module will adjust its behavior mode properly"""
    #####################<prerequisites>########################
