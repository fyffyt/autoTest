...
TESTCASE_ID = "Tc.config.reli.004"
TESTCASE_PRI = "M"
...
if __name__ == '__main__':
    """Config module need to check local config file
    for consistence with remote config file after start up.
    Currently, we cannot stop config module by will. so, just
    restart the FusionSensor."""
