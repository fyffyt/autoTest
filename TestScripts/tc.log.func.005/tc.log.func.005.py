...
if __name__ == '__main__':
    """Log level can be changed to ERROR by config file."""
    ...
    #####################<Test procedure>########################
#   1. Config log level to ERROR
#       ssh_dp_proc.sendline("python update_config.py %s '%s' "%(conf['nodes']['1st']['name'],str({"logLevel":"ERROR"})))
