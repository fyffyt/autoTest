...
if __name__ == "__main__":
    USAGE_STR = """python check_data_hole.py -t loi|video|zone-count|wifi -d 8600066"""
    ...
    if 'loi' == DATA_TYPE:
        ...
        DATA_DIR = '/data/wifi_dumpcap/dump'
    else:
        print(USAGE_STR)
        sys.exit(1)
    ...
    if None == DEV_NAME_REGEX.match(DEV_NAME):
        ...
        print("[MAX_HOLE_DURATION, TIME_BEFORE_HOLE, TIME_AFTER_HOLE]")
        print(MAX_DATA_HOLE)
